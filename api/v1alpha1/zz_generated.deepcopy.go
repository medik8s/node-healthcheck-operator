...
func (in *NodeHealthCheckStatus) DeepCopyInto(out *NodeHealthCheckStatus) {
	*out = *in
	if in.TriggeredRemediationTime != nil {
		in, out := &in.TriggeredRemediationTime, &out.TriggeredRemediationTime
		*out = make(TriggeredRemediationTime, len(*in))
		for key, val := range *in {
			var outVal []metav1.Time
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in TriggeredRemediationTime) DeepCopyInto(out *TriggeredRemediationTime) {
	{
		in := &in
		*out = make(TriggeredRemediationTime, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TriggeredRemediationTime.
func (in TriggeredRemediationTime) DeepCopy() TriggeredRemediationTime {
	if in == nil {
		return nil
	}
	out := new(TriggeredRemediationTime)
	in.DeepCopyInto(out)
	return *out
}
